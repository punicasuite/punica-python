...
class TestDeploy(unittest.TestCase):
    ...
    def test_generate_contract_address(self):
        hex_contract_address = Deploy.generate_contract_address(self.project_path)
    ...
    def test_unnormalized_deploy_contract(self, password):
        ...
        tx_hash = Deploy.deploy_smart_contract(project_path, self.network)
    ...
    def test_normalized_deploy_contract(self, password):
        ...
        tx_hash = Deploy.deploy_smart_contract(project_path, self.network, 'random.avm')
        time.sleep(6)
