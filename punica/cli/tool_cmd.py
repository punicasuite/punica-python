...
@click.option('--strtohex', nargs=1, type=str, default='', help='transform string to hex.')
...
@click.pass_context
def transform_cmd(addresstohex, strtohex, hexreverse, numtohex, generateprivatekey, decryptprivatekey):
    """
    transform data
    """
    if addresstohex != '':
