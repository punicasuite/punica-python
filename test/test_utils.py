...
class TestUtils(unittest.TestCase):
    def test_read_wallet(self):
        wallet_path = os.path.join(os.getcwd(), 'data', 'test_wallet', 'wallet')
        ...
        self.assertTrue(isinstance(wallet_manager, WalletManager))
        wallet_path = os.path.join(os.getcwd(), 'data', 'test_wallet', 'exist_wallet.json')
        self.assertRaises(PunicaException, read_wallet, wallet_path)
        wallet_path = os.path.join(os.getcwd(), 'data', 'test_wallet', 'error_wallet.json')
        self.assertRaises(PunicaException, read_wallet, wallet_path)
